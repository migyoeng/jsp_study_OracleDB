...
<!-- 본문 시작 bbsRead.jsp -->
<ul class="pager">
	<li class="previous"><a href="bbsList.jsp?col=<%=col %>&word=<%=word %>" class="btn btn-default next">뒤로 가기</a></li>
...
%> --%>
	...
	<br>
	<input type="button" value="답글 달기" class="btn btn-default btn-custom1" onclick="location.href='bbsReply.jsp?bbsno=<%=bbsno %>&col=<%=col%>&word=<%=word%>'">
