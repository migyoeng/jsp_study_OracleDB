...
<p class="text-right"><a href="bbsForm.jsp" class="btn btn-default btn-custom1">새 글 작성</a></p>
...
<%
	...
	ArrayList<BbsDTO> list = bbsDao.list3(col, word, nowPage, recordPerPage); //BbsDTO 타입을 담은 list 반환
	if(list == null){
		out.println("<tr>");
...
%>
				<strong>
					<a href="bbsRead.jsp?bbsno=<%=bbsDto.getBbsno() %>&col=<%=col %>&word=<%=word %>" id="bbslist_link">
						<%=bbsDto.getSubject() %>
					</a>
				</strong>
...
<%
		...
		//글 개수
		int totalRecord = bbsDao.count2(col, word);
		//tfoot 태그 추가하기
		out.println("<td colspan='2' style='text-align: left; vertical-align: middle'>");
...
%>
		<!-- 검색 시작 -->
			<td colspan="2" style="text-align: right; vertical-align: middle">
				<form action="bbsList.jsp" onsubmit="return searchCheck()" class="form-inline"><!-- myscript.js에서 작성 -->
