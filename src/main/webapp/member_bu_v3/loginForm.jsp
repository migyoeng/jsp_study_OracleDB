		...
		<table class="table form-inline">
			<tr>
				...
				<td rowspan="2">
					...
					<input type="submit" value="로그인" class="btn btn-default btn-custom1">
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="3" rowspan="2">아직 회원이 아니신가요?<br>
					<a href="agreement.jsp" class="btn btn-default">회원가입</a>
					&nbsp;|&nbsp;
					<a href="findID.jsp" class="btn btn-default">아이디/비밀번호 찾기</a>
				</td>
			</tr>
		</table>
	</form>
