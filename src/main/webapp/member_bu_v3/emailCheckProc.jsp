...
<body>
	<div style="text-align: center">
		<h4>이메일 중복 확인 결과</h4>
<%
	String email = request.getParameter("email1").trim() + "@" + request.getParameter("email2").trim();
...
%>
	...
	<a href="javascript:apply('<%=email %>')">사용하기</a>
	<script>
		function apply(email){
			//<form name="memfrm">
			//	<input type="text" name="id">
			opener.document.memfrm.email.value = email; //부모창 -> body 접근 -> memfrm 폼의 id의 value에 저장
			window.close();
		}//apply() end
	</script>
<%
