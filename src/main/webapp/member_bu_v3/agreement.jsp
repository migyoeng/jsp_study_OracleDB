...
<!-- 본문시작 agreement.jsp-->
<div style="text-align: center"><strong>* 회/원/약/관 *</strong></div>
<br>	    
<!--
...
① Community (www.greenart.co.kr) 서비스 약관(이하 "본 약관"이라 합니다)은 이용자가 ㈜ 그린컴퓨터아카데미(이하 "Community"이라 합니다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 합니다)를 이용함에 있 어 이용자와 "Community"의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
